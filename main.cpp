...
void iniTrain()
{
	availTrains[0].TName = "DIBRUGARH - NEW DELHI Rajdhani Express";
	availTrains[0].TID = "12235";
	availTrains[0].TSource = "DIBRUGARH";
	availTrains[0].TDest = "NEW-DELHI";
	...
	availTrains[1].TSource = "NEW-DELHI";
	availTrains[1].TDest = "HOWRAH-JN";
...
login:
	...
	if (user == "MRITUNJAY" && password == "MRIT007" || user == "RAJA" && password == "RAJA123")
	{
